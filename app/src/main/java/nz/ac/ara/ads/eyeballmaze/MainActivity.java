...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView[][] cellGridImages = new ImageView[7][5];
...
//        cellGridImages[0][0] = findViewById(R.id.cellGrid0);
    }

//    public void gridClickHandler(View view) {
//        int[] coordinartes = getCoordinates(view);
//
//
//    }
